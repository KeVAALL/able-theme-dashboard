          ...
          <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            {isPrimary ? (
              <Chip
                ...
                sx={{ backgroundColor: '#1DB4691F', color: '#11A75C', fontSize: 12, fontWeight: 600, borderRadius: '6px' }}
              />
            ) : (
              <Chip
                label="Make Primary"
                sx={{ backgroundColor: '#1DB4691F', color: '#21B546', fontSize: 12, fontWeight: 600, borderRadius: '6px' }}
              />
            )}
          </Grid>
        </Grid>
